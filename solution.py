...
class SOLUTION:
    ...
    def Create_Body(self):
            ...
            for i in range(l):
                ...
                counter+= 2
                k += 1
            # pyrosim.Send_Joint( name = "limb0_limb" + str(counter) , parent= "limb0", child = "limb" + str(counter), type = "revolute", position = [-0.3,0,0.45], jointAxis = "0 1 0")
            # pyrosim.Send_Cube(name="limb" + str(counter), pos=[-.2,0,0], size=[0.2,0.5,0.2], colorName="blue")

            # pyrosim.Send_Joint( name = "limb" + str(counter) + "_limb" + str(counter + 1) , parent= "limb" + str(counter), child = "limb" + str(counter + 1), type = "revolute", position = [-0.3,0,0], jointAxis = "1 0 0")
            # pyrosim.Send_Cube(name="limb" + str(counter + 1), pos=[-.2,0,0], size = [0.2, 0.3, 0.2],  colorName=color)
